...
import ProductoDaoMongoDB from '../productos/ProductosDaoMongoDB.js';
import userModel from '../../db/models/modelMongoCarrito.js';
...
const archivoProductos = new ProductoDaoMongoDB();
